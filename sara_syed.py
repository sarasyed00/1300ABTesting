...
a_return_noreturn = """5	5"""
b_return_noreturn = """5	2"""


#t_test for time to completion:
...
#chi2 test for return rate:
a_return_noreturn_list = data_to_num_list(a_return_noreturn)
b_return_noreturn_list = data_to_num_list(b_return_noreturn)
print(a_return_noreturn_list)
print(b_return_noreturn_list)
return_observed_grid = [a_return_noreturn_list, b_return_noreturn_list]
print(chi2_value(return_observed_grid)) # this should be .3119402
print("ch2 val")
print(perform_chi2_homogeneity_test(return_observed_grid)) # this should be .57649202
print("pval")
